...
| Buildings container | `sh * 0.13` ✅ LOCKED | SVG: `sh * 0.28` / PNG: `sh * 0.55` | per district × 1.96 | SVG: left:2%(A)/right:2%(B). PNG: left:10%(A)/left:68%(B) — B uses left anchor. At 1.96× total span=112.9%, parallax reveals edges. | — | — |
