...
| Buildings container | `sh * 0.13` ✅ LOCKED | SVG: `sh * 0.28` / PNG: `sh * 0.55` | per district × 1.96 | SVG: left:2%(A)/right:2%(B). PNG: left:10%(A)/left:68%(B). buildingInfo uses DISTRICT_A_LEFT=0.10, DISTRICT_B_LEFT=0.68 in pixel art — must stay in sync with container anchors. | — | — |
| Building img        | bottom:0                                       | SVG: `sh * hPct` / PNG: `sh * hPct * 1.96` | `bldg.w % × 1.96`   | —                                             | cover                                                                                  | bottom                                                                                                                                            |
...
```
Container height:  sh * 0.28 (SVG) / sh * 0.55 (PNG)
Building heights:  sh * hPct * scale (SVG: 1.0, PNG: 1.96)
