...
| **DistrictGuide A**     | `bottom: sh * 0.10` ✅ LOCKED                                                                     | 90px rendered                          | 60px rendered, x via useAnimate | **55**  | Male sheriff: walk=Walking-ddb7b148/east/frame_000–003, idle=Breathing_Idle-f1bd81e0/east/frame_000–003. 4 frames. Walk:375ms/frame, Idle:500ms/frame. scaleX(-1) inner wrapper for left-facing. To resize: change W/H in DistrictGuide.tsx only. |
| **DistrictGuide B**     | `bottom: sh * 0.10` ✅ LOCKED                                                                     | 90px rendered                          | 60px rendered, x via useAnimate | **55**  | Female sheriff: walk=Walking-640b08a6/east/frame_000–003, idle=Breathing_Idle-0056193a/south/frame_000–003. 4 frames. Walk:375ms/frame, Idle:500ms/frame. scaleX(-1) inner wrapper for left-facing. |
