...
| Building base | SVG: `sh * 0.10` / PNG: `sh * 0.13` ✅ LOCKED                   | SVG: `sh * 0.28` (container) / PNG: `sh * 0.55` (container). Individual: `sh * hPct * scale` where scale=1.96 for PNG | **Uniform scale rule: scale applies to BOTH width (district container + individual buildings) AND height. Never scale height alone. base stays locked via alignItems:flex-end.**                               |
...
| **Title card**          | —                                                                    | —                                      | —                               | **35**  | —                                            | —         | —                                                                                                                                                           |
| **Buildings container** | SVG: `sh * 0.10` / PNG: `sh * 0.13` ✅ LOCKED                        | SVG: `sh * 0.28` / PNG: `sh * 0.55`    | per district % × 1.96           | **30**  | SVG divs / PNG: `<img>`                      | cover     | bottom                                                                                                                                                      |
